...
from .routes import user_routes, auth_routes, menu_item_routes, restaurant_routes, review_routes, cart_routes, map_routes
...
app.register_blueprint(cart_routes, url_prefix="/api/shopping-carts")
